...
def non_max_suppression(
    ...
    if isinstance(prediction, (dict)):  # YOLOv10 model in validation model, output = (inference_out, loss_out)
        prediction_mid = prediction['one2many'][0]
        prediction = prediction_mid
