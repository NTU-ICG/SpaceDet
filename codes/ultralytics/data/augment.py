...
class RandomPerspective:
    ...
    def __call__(self, labels):
        ...
        new_instances = Instances(bboxes, task, segments, keypoints, bbox_format="xyxy", normalized=False)
        # Clip
...
class Format:
    ...
    def __call__(self, labels):
        ...
        labels["task"] = torch.from_numpy(instances.task) if nl else torch.zeros(nl)
